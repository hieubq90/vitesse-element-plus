...
export const useRenderLayout = () => {
        ...
        >
          ...
          >
            <div
              ...
              style="transition: all var(--transition-time-02);"
            >
              <ToolHeader class="border-bottom-1 border-[var(--top-tool-border-color)] border-solid bg-[var(--top-header-bg-color)] dark:border-[var(--el-border-color)]"></ToolHeader>

              {/* {tagsView.value
                ? (
                <TagsView class="border-bottom-1 border-top-1 border-[var(--tags-view-border-color)] border-solid dark:border-[var(--el-border-color)]"></TagsView>
                  )
                : undefined} */}
            </div>
  ...
  const renderTopLeft = () => {
    return (
      <>
        <div class="border-bottom-1 flex items-center border-[var(--top-tool-border-color)] border-solid bg-[var(--top-header-bg-color)] dark:border-[var(--el-border-color)]">
  ...
  const renderTop = () => {
    return (
      <>
        <div class="border-bottom-1 flex items-center justify-between border-[var(--top-tool-border-color)] border-solid bg-[var(--top-header-bg-color)] dark:border-[var(--el-border-color)]">
