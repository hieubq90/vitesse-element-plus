...
// 前端控制路由生成
export function generateRoutesFn1(routes: AppRouteRecordRaw[],
  keys: string[],
  basePath = '/'): AppRouteRecordRaw[] {
...
// 后端控制路由生成
export function generateRoutesFn2(routes: AppCustomRouteRecordRaw[]): AppRouteRecordRaw[] {
  const res: AppRouteRecordRaw[] = []
...
// 添加所有子菜单
function addToChildren(routes: RouteRecordNormalized[],
